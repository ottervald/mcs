<script lang="ts">
        ...
        let filters:string[] = ['All', 'Mundane', 'Expertise', 'Magical & Supernatural', 'Conjury Sphere', 'Grimoire Spell', 'Allies & Companions', 'Contacts & Factions', 'Starting Equipment', 'Chosen by Gods', 'MEGA SPECIAL'];
